        ...
        child: Column(
          ...
          children: [
            ...
            if (_existingUrls.isNotEmpty) ...[
              ...
              Text('EXISTING PHOTOS', style: GoogleFonts.bebasNeue(color: Colors.tealAccent, fontSize: 18)),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(image: MemoryImage(base64Decode(_existingUrls[i])), fit: BoxFit.cover),
                          ),
                        ),
                        Positioned(
                          right: 10,
            ...
            const SizedBox(height: 30),
            Text('ADD NEW PHOTOS', style: GoogleFonts.bebasNeue(color: Colors.tealAccent, fontSize: 18)),
            const SizedBox(height: 15),
            Row(
              children: [
